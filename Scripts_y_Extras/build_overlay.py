...
# I will find the block starting at MS_Origen and replacing it entirely up to just before <piece> tags.
# Wait, let's identify the start and end carefully.
# Start: <point angle="270" basePoint="100" id="12000" ... name="MS_Origen"
# End: we just need to replace everything inside the <nodes> after MS_Origen up to the end of <nodes>.
...
new_sleeve_nodes = """<point angle="270" basePoint="100" id="12000" length="0" mx="0.1" my="0.1" name="MS_Origen" showPointName="true" type="endLine"/>
            ...
            <!-- Curvas de Copa 1-Pieza (M.A.S. Rule) -->
            ...
            <!-- El corte trasero es exactamente el doblez -->
            ...
            <!-- Interseccion Copa (Cortando la curva 1-Pieza) -->
            <!-- En Seamly2D pointCurveIntersectAxis requiere curve, basePoint y angle -->
            <!-- Sin embargo, como el usuario extraerá manualmente, podemos usar pointLineIntersect con una linea vertical o simplemente Point of intersection of curve and axis -->
            <pointCurveIntersectAxis angle="90" basePoint="30011" curve="12020" id="30031" mx="0.1" my="0.1" name="Copa_Frente_Pico" showPointName="true"/>
            <pointCurveIntersectAxis angle="90" basePoint="30002" curve="12021" id="30032" mx="0.1" my="0.1" name="Copa_Espalda_Pico" showPointName="true"/>
            ...
            <point angle="180 - AngleLine_Fold_Frente_Codo_Fold_Frente_Puno" basePoint="30013" id="89502" length="@D_RUEDO_MANGA" mx="0.1" my="0.1" name="Ext_Corte_Frente" showPointName="true" type="endLine"/>
            <!-- Ruedo de la aletilla -->
