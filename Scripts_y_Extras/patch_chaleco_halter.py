...
for i, line in enumerate(lines):
    if 'id="21"' in line and 'name="D_Costado_Cintura_Guia"' in line:
        ...
        lines[i] = ''
    elif 'id="38"' in line and 'name="D_Princesa_Sisa_Real"' in line:
        lines[i] = line + '            <!-- Pinza de sisa (Apertura de volumen tridimensional) -->\n' + \
    ...
    elif 'id="41"' in line and 'secondPoint="17"' in line and 'firstPoint="38"' in line:
        lines[i] = line + '            <line firstPoint="3800" id="3801" secondPoint="19"/>\n' + \
        ...
        lines[i] = '            <spline angle1="AngleLine_D_Princesa_Sisa_Real_D_Punto_Pezon - 15" angle2="AngleLine_D_Punto_Pezon_D_Pinza_Izq - 180" id="42" length1="Line_D_Princesa_Sisa_Real_D_Punto_Pezon * 0.35" length2="Line_D_Princesa_Sisa_Real_D_Punto_Pezon * 0.35" point1="38" point4="17" type="simpleInteractive"/>\n' + \
