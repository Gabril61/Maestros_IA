...
# Spline 44001: Guia to Center
sp1 = calculation.find(".//spline[@id='44001']")
if sp1 is not None:
    sp1.set('angle1', 'AngleLine_B_F_Guia_Izq_Flip_B_F_Ancho_Izq_Flip - 15')
    sp1.set('angle2', '180')
...
# Spline 44002: Top Left to Guia
sp2 = calculation.find(".//spline[@id='44002']")
if sp2 is not None:
    sp2.set('angle1', 'AngleLine_B_Copa_Frente_Pico_B_F_Guia_Izq_Flip - 15')
    # Make angle2 perfectly tangent to angle1 of Spline 44001
    sp2.set('angle2', 'AngleLine_B_F_Guia_Izq_Flip_B_F_Ancho_Izq_Flip - 15 + 180')
...
# Spline 44003: Top Right to Center
sp3 = calculation.find(".//spline[@id='44003']")
if sp3 is not None:
    sp3.set('angle1', 'AngleLine_B_Copa_Espalda_Pico_B_T_Ancho_Der_Flip + 15')
    sp3.set('angle2', '0')
...
print("Splines beautifully fine-tuned for tangency.")
